...
public class MSMLegacy {
    ...
    public void onPreInit (FMLPreInitializationEvent event) {
        ...
        this.stealth = this.registry.registerEnchantment(this.config.getSwordEnchantment("stealth", this.adminiumArk, Rarity.COMMON, 1, 1, false), "stealth");
        this.extinction = this.registry.registerEnchantment(this.config.getSwordEnchantment("extinction", this.adminiumArk, Rarity.RARE, 1, 1, false), "extinction");
